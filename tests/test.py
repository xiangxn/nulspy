...
nuls = NULS("http://beta.api.nuls.io/jsonrpc", "21a69261f69f7194a771849b5aebcae95e415156097dc25648f621c7874bfac4")

async def run_test():
    hash = await nuls.transfer("tNULSeBaMfn8mwR6THZoGzCgDCx3oeLnT1TsKh", "tNULSeBaMsJmAAAo6ooXu3QHnQCNcmjv6JyBix",
                          100000, "p:36893488157591172664")
    print(hash)
...
def getTasks(loop):
    ...
    tasks += [loop.create_task(getBalance())]
    return tasks
